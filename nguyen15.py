#!/usr/bin/env python3
"""
nguyen15.py — Bot Caro (wrapper) — gamevh.net
Mức cược: 400 xu | KHÔNG đổi avatar | Tài khoản từ acc_valid_2.txt[7]
...
os.environ.setdefault("CARO_ACC_FILE", "acc_valid_2.txt")
os.environ.setdefault("CARO_ACC_INDEX", "7")
