#!/usr/bin/env python3
"""
zaro20.py — Bot Caro (wrapper) — gamevh.net
Mức cược: 400 xu | KHÔNG đổi avatar | Tài khoản từ acc_valid_3.txt[2]
...
os.environ.setdefault("CARO_ACC_FILE", "acc_valid_3.txt")
